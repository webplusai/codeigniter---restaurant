                        ...
                        <div class="col-sm-5">
                            <div class="radio radio-success">
                                <?php if ($subtract_stock == '1') { ?>
                                    <input type="radio" id="subtract_stock_0" name="subtract_stock" value="0" <?php echo set_radio('subtract_stock', '0'); ?>><label for="subtract_stock_0"><?php echo lang('text_no'); ?></label>
                                    <input type="radio" id="subtract_stock_1" name="subtract_stock" value="1" <?php echo set_radio('subtract_stock', '1', TRUE); ?>><label for="subtract_stock_1"><?php echo lang('text_yes'); ?></label>
                                <?php } else { ?>
                                    <input type="radio" id="subtract_stock_0" name="subtract_stock" value="0" <?php echo set_radio('subtract_stock', '0', TRUE); ?>><label for="subtract_stock_0"><?php echo lang('text_no'); ?></label>
                                    <input type="radio" id="subtract_stock_1" name="subtract_stock" value="1" <?php echo set_radio('subtract_stock', '1'); ?>><label for="subtract_stock_1"><?php echo lang('text_yes'); ?></label>
                                <?php } ?>
                            </div>
                        ...
                        <div class="col-sm-5">
                            <div class="radio radio-success">
                                <?php if ($menu_status == '1') { ?>
                                    <input type="radio" id="menu_status_0" name="menu_status" value="0" <?php echo set_radio('menu_status', '0'); ?>><label for="menu_status_0"><?php echo lang('text_disabled'); ?></label>
                                    <input type="radio" id="menu_status_1" name="menu_status" value="1" <?php echo set_radio('menu_status', '1', TRUE); ?>><label for="menu_status_1"><?php echo lang('text_enabled'); ?></label>
                                <?php } else { ?>
                                    <input type="radio" id="menu_status_0" name="menu_status" value="0" <?php echo set_radio('menu_status', '0', TRUE); ?>><label for="menu_status_0"><?php echo lang('text_disabled'); ?></label>
                                    <input type="radio" id="menu_status_1" name="menu_status" value="1" <?php echo set_radio('menu_status', '1'); ?>><label for="menu_status_1"><?php echo lang('text_enabled'); ?></label>
                                <?php } ?>
                            </div>
