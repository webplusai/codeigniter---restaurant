                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="col-sm-6 center-block">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <div class="btn btn-default btn-file-input">
                                        ...
                                        <input type="file" name="theme_zip" value="<?php echo set_value('theme_zip'); ?>" onchange="var file = this.files[0];$('.btn-file-input-value').val(file.name);$('.btn-file-input-change').removeClass('hide');$('.btn-file-input-browse').addClass('hide');" />
                                    </div>
                            ...
                            <?php echo form_error('theme_zip', '<span class="text-danger">', '</span>'); ?>
                        </div>
                    </div>
                </div>
            </div>
