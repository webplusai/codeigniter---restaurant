                                ...
                                <div class="col-md-5 pull-right text-right">
                                    <div class="form-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-range pull-right" role="menu">
                                            <li><a href="javascript:void(0);" rel="today"><?php echo lang('text_today'); ?></a></li>
                                            <li><a href="javascript:void(0);" rel="week"><?php echo lang('text_week'); ?></a></li>
                                            <li><a href="javascript:void(0);" rel="month"><?php echo lang('text_month'); ?></a></li>
                                            <li><a href="javascript:void(0);" rel="year"><?php echo lang('text_year'); ?></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
