...
$theme['title']         = 'TastyIgniter Black';
$theme['author']        = 'Bojan';
$theme['version']       = '1.0';
...
$theme['head_tags'] = array(
	'doctype'   => 'html5',
	'favicon'   => theme_url('tastyigniter-black/images/favicon.ico'),
	...
	// 'meta'     	=> array(
	// 	array('name' => 'X-UA-Compatible', 'content' => 'IE=edge', 'type' => 'equiv'),
	// 	array('name' => 'viewport', 'content' => 'width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0', 'type' => 'name'),
	// ),

	'style'    	=> array(
		array(theme_url('tastyigniter-black/css/bootstrap.min.css'), 'bootstrap-css', '10'),
		array(theme_url('tastyigniter-black/css/font-awesome.min.css'), 'font-awesome-css', '11'),
		array(theme_url('tastyigniter-black/css/select2.css'), 'select2-css', '13'),
		array(theme_url('tastyigniter-black/css/select2-bootstrap.css'), 'select2-bootstrap-css', '14'),
		array(theme_url('tastyigniter-black/css/jquery.raty.css'), 'jquery-raty-css', '15'),
		array(theme_url('tastyigniter-black/css/fonts.css'), 'fonts-css', '16'),
		array(theme_url('tastyigniter-black/css/custom.css'), 'custom-css', '18'),
		array(theme_url('tastyigniter-black/css/stylesheet.css'), 'stylesheet-css', '100100100100100'),

		array(theme_url('tastyigniter-black/barnelli2/less/custom.css'), 'custom-css', '17'),
	),

	// 'style'    	=> array(
	
	// 	array('http://fonts.googleapis.com/css?family=Open+Sans:400,300,600&amp;subset=latin,latin-ext', 'open-sans-font', '11'),
	// 	array('http://fonts.googleapis.com/css?family=Covered+By+Your+Grace', 'covered-font', '12'),
	// 	array(theme_url('tastyigniter-black/barnelli2/less/jquery.maximage.css'), 'jquery-maximage-css', '13'),
	// ),


	'script'   	=> array(
		array(theme_url('tastyigniter-black/barnelli2/js/jquery-2.0.3.min.js'), 'jquery-js', '1'),
		array(theme_url('tastyigniter-black/barnelli2/js/modernizr-2.6.2.min.js'), 'modernizr-js', '2'),

		array(theme_url('tastyigniter-black/barnelli2/js/jquery.djax.js'), 'jquery-djax-js', '3'),
		array(theme_url('tastyigniter-black/barnelli2/js/jquery.nicescroll.min.js'), 'jquery-nicescroll-js', '4'),
		array(theme_url('tastyigniter-black/barnelli2/js/jquery.ba-throttle-debounce.min.js'), 'jquery-debounce-js', '5'),
		array(theme_url('tastyigniter-black/barnelli2/js/transit.js'), 'transit-js', '6'),
		array(theme_url('tastyigniter-black/barnelli2/js/jquery.cycle.all.min.js'), 'jquery-cycle-js', '7'),
		array(theme_url('tastyigniter-black/barnelli2/js/jquery.maximage.min.js'), 'jquery-maximage-js', '8'),
		array(theme_url('tastyigniter-black/barnelli2/js/jquery.colorbox-min.js'), 'jquery-colorbox-js', '9'),
		array(theme_url('tastyigniter-black/barnelli2/js/owl.carousel.min.js'), 'owl-carousel-js', '10'),
		array(theme_url('tastyigniter-black/barnelli2/js/main.js'), 'main-js', '100'),

		array(theme_url('tastyigniter-black/js/bootstrap.min.js'), 'bootstrap-js', '15'),
		array(theme_url('tastyigniter-black/js/select2.js'), 'select-2-js', '16'),
		array(theme_url('tastyigniter-black/js/jquery.raty.js'), 'jquery-raty-js', '17'),
		array(theme_url('tastyigniter-black/js/common.js'), 'common-js', '100100100100100'),
	),

	// 'script'   	=> array(
	// 	array(theme_url('tastyigniter-black/barnelli2/js/jquery-2.0.3.min.js'), 'jquery-js', '1'),
	// 	array(theme_url('tastyigniter-black/barnelli2/js/modernizr-2.6.2.min.js'), 'modernizr-js', '10'),

	// 	array(theme_url('tastyigniter-black/barnelli2/js/jquery.djax.min.js'), 'jquery-djax-js', '12'),
	// 	array(theme_url('tastyigniter-black/barnelli2/js/jquery.nicescroll.min.js'), 'jquery-nicescroll-js', '13'),
	// 	array(theme_url('tastyigniter-black/barnelli2/js/jquery.ba-throttle-debounce.min.js'), 'jquery-debounce-js', '14'),
	// 	array(theme_url('tastyigniter-black/barnelli2/js/transit.js'), 'transit-js', '15'),
	// 	array(theme_url('tastyigniter-black/barnelli2/js/jquery.cycle.all.min.js'), 'jquery-cycle-js', '16'),
	// 	array(theme_url('tastyigniter-black/barnelli2/js/jquery.maximage.min.js'), 'jquery-maximage-js', '17'),
	// 	array(theme_url('tastyigniter-black/barnelli2/js/jquery.colorbox-min.js'), 'jquery-colorbox-js', '18'),
	// 	array(theme_url('tastyigniter-black/barnelli2/js/owl.carousel.min.js'), 'owl-carousel-js', '19'),
	// 	array(theme_url('tastyigniter-black/barnelli2/js/main.js'), 'main-js', '20')
	// ),
);
...
/* Location: ./main/views/themes/tastyigniter-black/theme_config.php */